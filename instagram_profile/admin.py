...
from .models import Post, InstagramConfiguration
...
class PostAdmin(admin.ModelAdmin):
    ...
    def sync(self, request):
        ...
        if code:
            ...
            return HttpResponseRedirect(setting.INSTAGRAM_AUTH_URL + '?' + urlencode(query))


admin.site.register(Post, PostAdmin)
admin.site.register(InstagramConfiguration)
