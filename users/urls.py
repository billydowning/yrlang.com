...
urlpatterns = [
    ...
    path('provider-monthly-subscription/', views.ProviderSubscriptionView.as_view(), name='subscription'),
    ...
    #request for call
    path('request-for-call/<int:user_id>', views.RequestForCallWithMailView.as_view(), name='request_for_call'),
    #user Review
